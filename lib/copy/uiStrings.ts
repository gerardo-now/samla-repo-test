...
export const UI = {
  ...
  agents: {
    ...
    tools: {
      ...
      transferHuman: "Transferir a humano",
      transferAgent: "Transferir a otro agente",
    },
    tones: {
    ...
    transfer: {
      ...
      toHuman: "Transferir a humano",
      toAgent: "Transferir a otro agente",
      phoneNumber: "Número de teléfono",
      phoneNumberDescription: "El número al que se transferirán las llamadas",
      message: "Mensaje antes de transferir",
      conditions: "Condiciones para transferir",
      conditionFrustrated: "Cliente frustrado o molesto",
      conditionRequest: "Cliente solicita hablar con humano",
      conditionComplex: "Pregunta compleja que no puede responder",
      conditionHighValue: "Cliente de alto valor",
      conditionComplaint: "Queja formal",
      targetAgent: "Agente destino",
      escalation: "Escalamiento automático",
      escalateFrustration: "Escalar cuando el cliente está frustrado",
      escalateRequest: "Escalar cuando el cliente pide un humano",
    },
    hours: {
      title: "Horario de atención",
      enabled: "Limitar horario de atención",
      enabledDescription: "Define horarios específicos para que el agente responda",
      start: "Hora inicio",
      end: "Hora fin",
      days: "Días laborales",
      afterHoursMessage: "Mensaje fuera de horario",
